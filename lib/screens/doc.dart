...
class _DocumentScreenState extends ConsumerState<DocumentScreen> {
  ...
  void fetchDocumentData() async {
    ...
    _controller!.document.changes.listen((event) {
      if (event.change == ChangeSource.LOCAL) {
        ...
        actions: [
          Padding(
            ...
            child: ElevatedButton.icon(
              onPressed: () {
                Clipboard.setData(ClipboardData(text: widget.id)).then(
                      (value) {
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              List<dynamic> myList = errorModel!.data.content;
              String result = '';
              for (var item in myList) {
                String itemString = item.toString();
                itemString = itemString.replaceAll(RegExp(r'\[{insert:|\}$'), '');
                result += itemString;
              }
              String results = result.replaceAll(RegExp(r'\{insert:|\}$'), '');
               // String resultss = results.replaceAll(RegExp(r'\{image:|\}$'), '');
              print(results);
  ...
  Widget _buildWelcomeEditor(BuildContext context) {
    ...
    if (_isDesktop()) {
      toolbar = QuillToolbar.basic(
        ...
        multiRowsDisplay: false,
        sectionDividerSpace: 20,
        toolbarSectionSpacing: 20,
